...
@section('page_title')
    {{ __('api::app.notification.new-notification') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('api.notification.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                        ...
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                                <label for="title" class="required">
                                    {{ __('api::app.notification.notification-title') }}
                                </label>

                                <input type="text" class="control" name="title" v-validate="'required'" value="{{ old('title') }}" data-vv-as="&quot;{{ __('api::app.notification.notification-title') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('content') ? 'has-error' : '']">
                                <label for="content" class="required">
                                    {{ __('api::app.notification.notification-content') }}
                                </label>
                                <textarea  class="control" name="content" v-validate="'required'" data-vv-as="&quot;{{ __('api::app.notification.notification-content') }}&quot;" cols="30" rows="10">{{ old('content') }}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('image') ? 'has-error' : '']">
                                ...
                                <image-wrapper :button-label="'{{ __('api::app.notification.notification-image') }}'" input-name="image" :multiple="false" ></image-wrapper>
                            ...
                            <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                                ...
                                <select class="control" name="status" data-vv-as="&quot;{{ __('api::app.notification.notification-status') }}&quot;">
                                    <option value="1">{{ __('api::app.notification.status.enabled') }}</option>
                                    <option value="0">{{ __('api::app.notification.status.disabled') }}</option>
                                </select>
        ...
        <div>
            <div class="control-group" :class="[errors.has('type') ? 'has-error' : '']">
                ...
                <select class="control" id="type" name="type" v-validate="'required'" data-vv-as="&quot;{{ __('api::app.notification.notification-type') }}&quot;" @change="showHideOptions($event)" v-model="notificationType">
                    ...
                    <option value="others">{{ __('api::app.notification.notification-type-option.simple') }}</option>
                    <option value="product">{{ __('api::app.notification.notification-type-option.product') }}</option>
                    <option value="category">{{ __('api::app.notification.notification-type-option.category') }}</option>
                </select>
